...
public class HomePageController {
	...
	//CREATE avaa html-sivun addthing.html, joka löytyy src/main/resources/templates kansiosta
	...
	// DELETE poistaa id:n mukaiasen thing olion. Huom näytetään vain, jos käyttäjän rooli = ADMIN
